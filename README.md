...
[Writing a custom Go network protocol](https://reintech.io/blog/writing-a-custom-go-network-protocol)

[The GO standard library, of course](https://pkg.go.dev/std)

[GO advanced concurrency patterns]("https://blogtitle.github.io/go-advanced-concurrency-patterns-part-4-unlimited-buffer-channels/")
